...
if __name__ == '__main__':
    ...
    test_images_path = '/home/coldmanck/kaggle/ImagesTrainCropAllTrain'
    with open('/home/coldmanck/kaggle/label_train.txt', 'r') as f:
        data = f.readlines()
        for line in data:
            words = line.split()
            name = words[0]
    ...
    print 'Total accuracy: ', (correct / total_num)
