...
#PRETRAINED = '/media/VSlab/coldmanck/fast-rcnn/caffe-fast-rcnn/examples/kaggle2/vgg16/bvlc_vgg16_txt_lr_1e-3_resize_rotated_batch_5_iter_100_100_iter_20000.caffemodel'
PRETRAINED = '/media/VSlab/coldmanck/fast-rcnn/caffe-fast-rcnn/examples/kaggle2/new_vgg16/bvlc_vgg16_txt_step_iter_30000.caffemodel'
...
def caffe_predict(path, name):
        ...
        save_mat_dir = os.path.join(caffe_root, 'result', 'vgg16', 'mat')
...
if __name__ == '__main__':
    ...
    test_images_path = '/home/coldmanck/kaggle/RightWhaleDetResults/testcrops_size_224'
