...
for i = 3:size(test_images_dir, 1)
	test_image_paths = [test_image_paths; ['../ImagesTestCrop/' ,test_images_dir(i).name]];
...
switch lower(FEATURE)    
    ...
    case 'bag of sift'
        ...
        vocab_size = 5000; %Larger values will work better (to a point) but be slower to compute
