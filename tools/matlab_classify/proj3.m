...
for t = 1:times
    ...
    switch lower(FEATURE)    
        ...
        case 'bag of sift'
            ...
            vocab_size = 3000; %Larger values will work better (to a point) but be slower to compute
            ...
            if ~exist(['train_image_feats_size', num2str(vocab_size), '_t', num2str(t), '.mat'], 'file')
                train_image_feats = get_bags_of_sifts_trainval(train_image_paths, vocab_size, t);
            ...
            if ~exist(['test_image_feats_size', num2str(vocab_size),  '_t', num2str(t),'.mat'])
                test_image_feats = get_bags_of_sifts_trainval(test_image_paths, vocab_size, t);
...
if ~exist(['final_test_image_feats_size', num2str(final_vocab_size),'.mat'])
	final_test_image_feats  = get_bags_of_sifts_trainval(final_test_image_paths, final_vocab_size, max_time);
...
file_name = 'submission_chiou2.csv';
result_to_csv(final_test_image_names, final_predicted_categories, categories, file_name);
